 ...
 * Unicode Key Mapping
 */
export const unicodeMapping: object = {
 ...
 * Replacement Array
 */
export const replacementRules: Array<any> = [
    ["्ा", ""], ["(त्र|त्त)({^उभप}+?)m", "$1m$2"], ["त्रm", "क्र"], ["त्तm", "क्त"], ["({^उभप}+?)m", "m$1"], ["उm", "ऊ"], ["भm", "झ"], ["पm", "फ"], ["इ{", "ई"], ["ि((.्)*{^्})", "$1ि"], ["(.{ािीुूृेैोौंःँ}*?){", "{$1"], ["((.्)*){", "{$1"], ["{", "र्"], ["({ाीुूृेैोौंःँ}+?)(्(.्)*{^्})", "$2$1"], ["्({ाीुूृेैोौंःँ}+?)((.्)*{^्})", "्$2$1"], ["({ंँ})({ािीुूृेैोौः}*)", "$2$1"], ["ँँ", "ँ"], ["ंं", "ं"], ["ेे", "े"], ["ैै", "ै"], ["ुु", "ु"], ["ूू", "ू"], ["^ः", ":"], ["टृ", "ट्ट"], ["ेा", "ाे"], ["ैा", "ाै"], ["अाे", "ओ"], ["अाै", "औ"], ["अा", "आ"], ["एे", "ऐ"], ["ाे", "ो"], ["ाै", "ौ"],
];
